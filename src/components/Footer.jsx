...
const Footer = ({className}) => {
    return (
        <section className={`bg-[#1B1612] px-6 sm:px-16 lg:px-24 pt-10 sm:pt-14 lg:pt-20 lg:pb-10 -mt-4 sm:mt-0 rounded-2xl sm:rounded-none lg:rounded-2xl relative overflow-hidden lg:mb-5 ${className}`}>
            ...
            <div className="max-w-[1580px] w-full mx-auto flex gap-4 items-center relative z-10">
                <Image src={logoMobile} alt="logo" />
                <h3 className="font-syne font-semibold text-2xl text-white">in.code</h3>
            </div>
            <div className="max-w-[1580px] mx-auto flex flex-col lg:flex-row mt-10 lg:justify-between relative z-10">
            ...
            <hr className="max-w-[1580px] mx-auto mt-16 lg:mt-20 border-[#ccc] opacity-10 relative z-10" />
            <div className="max-w-[1580px] mx-auto mt-4 flex justify-center lg:justify-between relative z-10">
