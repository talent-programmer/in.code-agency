            ...
            <div className="flex flex-col lg:flex-row mt-10 lg:justify-between">
                <div className="lg:w-[45%]">
                    <h1 className="font-Grotesk font-medium text-white text-2xl lg:text-4xl">
                        Starting a <i className="font-Petit">new project</i> or want to collaborate with us?
                    </h1>
                    ...
                    <button className="hidden lg:blockflex items-center text-[#ccc] gap-2 mt-10 hover:text-white">
                        <h3 className="font-Jakarta font-normal text-lg">Get in touch</h3>
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.73224 1.51824C7.16947 1.95547 8.25429 2.17644 9.23953 2.28722C10.5088 2.43218 11.7975 2.37738 13.0385 2.07804C13.9689 1.85353 15.0078 1.49232 15.5711 0.928989M15.5711 0.928989C15.0078 1.49232 14.6459 2.53176 14.422 3.46161C14.1233 4.70317 14.0685 5.99187 14.2123 7.25995C14.3236 8.24578 14.5458 9.33177 14.9818 9.76782M15.5711 0.928989L1.42894 15.0711" stroke="currentcolor" stroke-width="1.5"/>
                        </svg>
                    </button>
                ...
                <div className="w-full lg:w-[35%] flex justify-start mt-16 sm:mt-20 lg:mt-0">
                    <div className="w-1/2">
                        ...
                        <div className="flex flex-col gap-4 mt-8">
                            <h3 className="font-Jakarta text-[#ccc] text-base flex border-b-white border-b-2 border-hidden hover:text-white hover:border-solid">Instagram</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex relative transition-transform duration-3000 ease-in-out origin-left hover:transform hover:cursor-pointer hover:text-white">Facebook</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">LinkedIn</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base border-b-white border-b-2">Threads</h3>
                        </div>
                    </div>
                    <div className="w-1/2">
                        <h1 className="font-Grotesk font-medium text-white text-xl">Quick Links</h1>
                        <div className="flex flex-col gap-4 mt-8">
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Home</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Services</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Case Study</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Process</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Blog</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Contact</h3>
                            <h3 className="font-Jakarta text-[#ccc] text-base flex">Sitemapy</h3>
                        </div>
                    </div>
                </div>
            </div>
