...
import { logoDesktop, logoMobile } from "../../../public/assetes/img";
...
const NavBar = () => {
    ...
    return (
        <div className="fixed z-50 w-full top-8">
            ...
            {/* { menuOpen &&
                <div className="bg-[#1B1612] h-[100vh] max-w-96 relative px-6 sm:px-16">
                    <h1 className="font-Grotesk font-semibold text-white text-base">Services</h1>
                    <h1 className="font-Grotesk font-semibold text-white text-base">Work</h1>
                    <h1 className="font-Grotesk font-semibold text-white text-base">Process</h1>
                    <h1 className="font-Grotesk font-semibold text-white text-base">Blog</h1>
                </div>
            } */}
        </div>
    )
