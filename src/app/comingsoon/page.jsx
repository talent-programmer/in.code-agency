...
const ComingSoon = () => {
    return (
        <main className="bg-[#1B1612] relative pt-12 pb-8 overflow-hidden sm:pt-8 lg:pt-24 rounded-2xl">
            ...
            <div className="max-w-[1580px] mx-auto flex justify-center items-center gap-2 lg:gap-4 relative z-10">
            ...
            <div className="max-w-[1580px] mx-auto flex flex-col justify-center items-center mt-[234px] px-11 sm:px-28 sm:mt-[440px] lg:mt-48 relative z-10">
            ...
            <div className="max-w-[1580px] mx-auto mt-[206px] sm:mt-[375px] lg:mt-[263px] flex flex-col gap-[30px] sm:gap-10 lg:gap-[30px] justify-center items-center relative z-10">
