...
const ComingSoon = () => {
    return (
        <main className="bg-[#1B1612] relative pt-12 pb-8 overflow-hidden sm:pt-8 lg:pt-24 rounded-2xl">
            {/* <Image src={noiseOverlay} className="absolute z-[1] hidden lg:block opacity-60" />
            ...
            <div className="flex flex-col justify-center items-center mt-[234px] px-11 sm:px-28 sm:mt-[440px] lg:mt-48">
