    ...
    return (
        <main className="bg-[#FFFAF6] w-full lg:px-10">
            ...
            <section className="bg-[#1B1612] relative lg:overflow-hidden px-6 sm:px-16 lg:px-24 pt-8 pb-20 lg:pb-40 lg:rounded-2xl">
                ...
                <nav className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-20">
                        <Image src={menu} className="block lg:hidden" />
            ...
            <section className="bg-[#1B1612] w-full lg:rounded-2xl px-6 sm:px-16 lg:px-0 relative lg:mt-5">
                <Image src={bg1} className="relative z-10 rounded-2xl hidden sm:block" />
                <Image src={bg1Mobile} className="w-full relative z-10 rounded-2xl sm:hidden" />
            ...
            <section className="bg-[#1B1612] w-full lg:rounded-2xl px-6 sm:px-16 lg:px-0 relative overflow-hidden lg:mt-5">
                <Image src={bg2} className="rounded-2xl hidden sm:block" />
                <Image src={bg2Mobile} className="w-full relative z-10 rounded-2xl sm:hidden" />
            </section>
            ...
            <section className="bg-[#1B1612] w-full lg:rounded-2xl px-6 sm:px-16 lg:px-0 py-1 lg:py-0 relative overflow-hidden lg:mt-5">
                <Image src={bg3} className="rounded-2xl hidden sm:block" />
                <Image src={bg3Mobile} className="w-full relative z-10 rounded-2xl sm:hidden" />
            </section>
            <section className="bg-[#1B1612] w-full lg:rounded-2xl px-6 sm:px-16 lg:px-0 py-1 lg:py-0 relative overflow-hidden lg:mt-5">
                <Image src={bg4} className="rounded-2xl] hidden sm:block" />
                <Image src={bg4Mobile} className="w-full  z-10 rounded-2xl sm:hidden" />
            </section>
            <section className="bg-[#1B1612] w-full lg:rounded-2xl px-6 sm:px-16 lg:px-0 py-1 lg:py-0 relative overflow-hidden lg:mt-5">
                <Image src={bg5} className="rounded-2xl hidden sm:block" />
                <Image src={bg5Mobile} className="w-full relative z-10 rounded-2xl sm:hidden" />
            </section>
            <section className="bg-[#1B1612] lg:bg-white relative px-6 sm:px-16 lg:px-0 pt-2 pb-16 sm:py-10 lg:py-28">
                ...
                <div className="bg-white relative z-10 flex justify-center items-cente py-7 lg:py-0 gap-5 rounded-2xl">
                    <Image src={arrowLeftMobile} className="lg:hidden" />
                    <Image src={arrowBlack} className="hidden lg:block" />
